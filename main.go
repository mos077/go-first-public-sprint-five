...
type Training struct {
	...
	LenSteping   float64       // длина одного шага или гребка в м
...
func (t Training) distance() float64 {
	...
	resDistance := float64(t.Action) * t.LenSteping / MInKm
	return resDistance
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	averageSpeed := r.distance()
	return (CaloriesMeanSpeedMultiplier*averageSpeed + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesMeanSpeedMultiplier*w.Weight + (math.Sqrt(w.meanSpeed()*KmHInMsec)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
